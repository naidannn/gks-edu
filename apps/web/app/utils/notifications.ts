...
export const NOTIFICATION_EVENT_LABELS: Record<NotificationEvent, string> = {
  ...
  CONTRACT_READY: 'Гэрээ гарын үсэг хүлээж байна',
...
export const NOTIFICATION_EVENT_GROUPS: { title: string; events: NotificationEvent[] }[] = [
  ...
  {
    title: 'Гэрээ ба төлбөр',
    events: ['CONTRACT_READY', 'CONTRACT_CONFIRMED', 'PAYMENT_DUE', 'PAYMENT_CONFIRMED'],
  },

      ...
      <template v-else-if="submitted && definition">
        <DsCard padding="var(--sp-6)">
          ...
          <ol class="gks-essay__next">
            ...
            <li><strong>Та хянана.</strong> Эссэ энд, системд харагдана — уншаад сэтгэгдэл үлдээж, зөв болсон хойно баталгаажуулна.</li>
          </ol>
          <p class="gks-essay__muted">
            Бэлэн болсон эссэгээ <NuxtLink :to="`/app/essays/${caseId}`">«Миний эссэ»</NuxtLink> хуудаснаас уншиж, сэтгэгдлээ үлдээнэ.
            Нэмж хэлэх зүйл санаанд орвол <NuxtLink to="/messages">зөвлөхдөө чатаар бичээрэй</NuxtLink>.
          </p>
        </DsCard>

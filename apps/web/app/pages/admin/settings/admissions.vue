    ...
    <template v-else>
      ...
      <DsCard title="Интернэтээс судлах">
        <p class="gks-adm-config__note">
          ...
          Элсэлтийн судалгаа Google хайлтаар ажилладаг тул эх сурвалжийн холбоостой ирнэ;
          хайлт ажиллаагүй бол бүх санал <strong>LOW</strong> болж, шалгуулах тэмдэглэл нэмэгдэнэ.
        </p>
        <div class="gks-form-grid">
          <DsInput

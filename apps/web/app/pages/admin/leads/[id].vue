...
/** Staff lead detail: profile, stage transitions, assignment, activity timeline (1B-02/03/04/07). */
...
useHead({ title: () => (lead.value ? `${lead.value.lastName} ${lead.value.firstName}` : 'Сэжим') });
</script>

<template>
  <div class="gks-lead">
    <NuxtLink to="/admin/leads" class="gks-lead__back"><DsIcon name="arrow-left" :size="16" /> Сэжимүүд</NuxtLink>

    <DsCard v-if="leadError" accent><p>Сэжимийг ачаалж чадсангүй.</p></DsCard>

...
8. **Унтраах товч.** `enabled=false` эсвэл төсөв дуусахад виджет мессенжер/зөвлөгөөний форм
   руу зөөлөн шилжинэ. Хэзээ ч хоосон дэлгэц үлдээхгүй. `enabled=false` үед
   `POST /ai/chat/sessions` мөр ч үүсгэхгүй, шууд 503 буцаана — унтраалттай туслах
   сесс бүртгэж, код зарцуулж, токен тарааж болохгүй. Анхны утга нь `false`, тул
   2C виджет гарах хүртэл нийтийн API бүхэлдээ хөдөлгөөнгүй байна.

...
| [15. Нээлттэй асуултууд](#15-нээлттэй-асуултууд) | бизнесээс хариу хэрэгтэй |
...
|---|---|---|
| Персона | `AiAssistantConfig.persona` (админ бичнэ) | "Чи GKS EDU GROUP-ийн зөвлөх туслах. Найрсаг, товч, монголоор." |
...
| `get_service_pricing(serviceType)` | `PricingService` | PUBLIC | одоогийн үнэ, урьдчилгаа, үлдэгдлийн болзол (виз/тэтгэлгийн дараа — үйлчилгээгээр) |
...
| Хувийн мэдээлэл | `get_my_*` дуудагчийн userId-аар; copilot `CaseAccessGuard`; зочны транскрипт 90 хоногийн дараа устгагдана (§15 асуулт); лог-д мессежийн агуулга байхгүй |
...
`ARCHITECTURE.md` §18-д 28–33 гэж бүртгэсэн. Бизнесээс хариу ирэх хүртэл анхдагч утгаар явна.

| # | Асуулт | Анхдагч |
|---|---|---|
| 28 | Туслахын нэр, персона, дуудлагын хэлбэр ("та"/"чи") | нэргүй "GKS EDU туслах", "та" |
| 29 | Утас цуглуулах зөвшөөрлийн өгүүлбэр, транскриптийг хэдэн хоног хадгалах | "Зөвлөх залгахын тулд утсыг тань авъя — зөвшөөрч байна уу?"; зочин 90 хоног, нэвтэрсэн гэрээний хугацаанд |
| 30 | Ажлын цаг (handoff "онлайн" гэж хэлэх цонх) | Да–Ба 09–18, Бя 10–14 |
| 31 | Сарын өртгийн тааз ($) | $60/сар ≈ 3 сая токен/өдөр |
| 32 | Зочинд үнийн яг дүн хэлэх үү (§13.3 "ерөнхий") | тийм — үнэ вэбсайтад нийтлэгдсэн |
| 33 | Copilot зөвлөх өөрт хуваарилагдаагүй сэжим асууж болох уу | §18-22-ын хариултыг дагана |
